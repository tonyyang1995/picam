...
class Options():
	...
	def initialize(self):
		...
		self.parser.add_argument('--model_name', type=str, default='picam', help='resnet3d, autoendoer')
		...
		self.parser.add_argument('--dataset_mode', type=str, default='picam', help='singleModality, ROI, Rawdata')
